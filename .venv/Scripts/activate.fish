...
set -gx VIRTUAL_ENV 'D:\Assigment1\medical-backend-flask\medical-backend\medical-backend\.venv'
...
if test -n medical-backend-py3.14
    set -gx VIRTUAL_ENV_PROMPT medical-backend-py3.14
else
